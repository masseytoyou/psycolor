...
# 기본 설정
# =========================================================
st.set_page_config(page_title="Psycolor", page_icon="🧠", layout="wide")
...
def render_auth_page() -> None:
    ...
    with tab2:
        ...
        sign_role = st.selectbox(
            "회원 유형",
            options=["general", "senior", "expert", "admin"],
        ...
        if sign_role != "admin":
            ...
            admin_code = st.text_input("관리자 가입 코드", type="password", key="admin_signup_code")
        ...
        if st.button("회원가입", use_container_width=True):
            try:
                ...
                if sign_role == "admin" and admin_code != get_admin_signup_code():
                    raise ValueError("관리자 가입 코드가 올바르지 않습니다.")
